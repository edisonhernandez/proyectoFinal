...
public class Empleado implements Serializable {
    ...
    @ManyToOne
    private Estado codigoEstadoCivil;
    ...
    public Estado getCodigoEstadoCivil() {
        return codigoEstadoCivil;
    }

    public void setCodigoEstadoCivil(Estado codigoEstadoCivil) {
    ...
    public String toString() {
        return "com.proyectodistribuidas.entidades.Empleado[ codigo=" + codigo + " ]";
    }
